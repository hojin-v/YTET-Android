...
grep -q 'buildSettingsTab' "$root/app/src/main/java/com/ytet/android/ui/MainActivity.java"
grep -q 'showExpandedPlayer' "$root/app/src/main/java/com/ytet/android/ui/MainActivity.java"
grep -q 'PREF_HIDE_SHORT_AUDIO' "$root/app/src/main/java/com/ytet/android/ui/MainActivity.java"
