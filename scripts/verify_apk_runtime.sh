...
require_entry '^assets/chaquopy/requirements-x86_64\.imy$' "missing x86_64 yt-dlp requirements archive"
require_entry '^lib/arm64-v8a/libpython3\.12\.so$' "missing arm64 embedded Python runtime"
require_entry '^lib/x86_64/libpython3\.12\.so$' "missing x86_64 embedded Python runtime"
